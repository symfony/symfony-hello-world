...
# Symfony
cd symfony && rm -rf README.md phpunit.xml* tests *.sh autoload* vendor src/Symfony/Bundle/Doctrine* \
src/Symfony/Bundle/SwiftMailerBundle src/Symfony/Bundle/TwigBundle src/Symfony/Bundle/ZendBundle \
src/Symfony/Bundle/WebProfilerBundle src/Symfony/Bundle/SecurityBundle src/Symfony/Bundle/AsseticBundle \
